    ...
    <Container className=" mx-auto max-w-[1110px] px-5 pb-5 pt-20 text-dark-500 lg:pt-32 ">
      ...
      <h1 className="  mx-auto pb-5 font-melodrama text-4xl font-bold text-slate-900 sm:text-7xl">
        ...
        <span className="relative whitespace-nowrap ">
          ...
          <span className="relative font-generalSans font-medium italic underline decoration-orange-500 decoration-4">
      ...
      <div className=" mt-12 flex flex-row md:space-x-14 -sm:flex-col   ">
        ...
        <div className=" h-full text-2xl md:self-end -sm:pt-6 -sm:pb-16 -sm:text-xl ">
          <Balancer>
            We understand that great design is about more than just aesthetics, it's about creating
            a seamless and satisfying user journey. That's why our team of expert designers focus on
            user research, testing, and iteration to ensure that{' '}
            <span className="font-medium italic underline decoration-orange-500 decoration-4">
              {' '}
