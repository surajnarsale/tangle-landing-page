...
const ClientsBanner = (props: PropsWithChildren<ClientsBannerProps>): JSX.Element => {
  ...
  return (
    <div className={clsx('bg-dark-300 ', props.className)}>
      <Container className="mx-auto max-w-[1110px] px-5 py-[60px] text-dark-500 md:py-[151px] ">
        <div>
        ...
        <div className=" mt-14   items-start  md:mt-20  md:flex -md:grid -md:grid-cols-2 -md:gap-8 ">
